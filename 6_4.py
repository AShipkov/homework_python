...
class Car:
    ...
    def show_speed(self):
        return f'\nВаша скорорсть {self.speed} км/ч'
class TownCar(Car):
    def show_speed(self):
        if self.speed > 60:
            return f'\nВаша скорость {self.speed} выше допустимой 60 км/ч'
        else:
            return f'Ваша скорость {self.speed}'
class WorkCar(Car):
    def show_speed(self):
        if self.speed > 40:
            return f'\nВаша скорость {self.speed} км/ч выше допустимой 40 км/ч'
        else:
